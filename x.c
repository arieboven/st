...
static char *opt_alphaUnfocused = NULL;
...
xloadalpha(void)
{
    ...
    if (opt_alphaUnfocused) alphaUnfocused = strtof(opt_alphaUnfocused, NULL);
...
main(int argc, char *argv[])
{
	...
	case 'A':
		...
		break;
    case 'U':
        opt_alphaUnfocused = EARGF(usage());
        break;
	case 'c':
